...
public class validationrules {
	...
	public static patient inputall(int serialno, int age, String name, String gender, String address, String phoneno,
			String disease, String admitdate, double bill, double income, String rooms, List<patient> list)
